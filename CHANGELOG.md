...
* Uitbreiding Card: property `clickable` om klikbaarheid aan te geven ([#2016](https://github.com/dso-toolkit/dso-toolkit/issues/2016))
...
* Ozon Content: Ondersteuning bron bij tabel ([#1954](https://github.com/dso-toolkit/dso-toolkit/issues/1954))
* rich-content html/css template ([#1909](https://github.com/dso-toolkit/dso-toolkit/issues/1909))
...
* Minified CSS ([#1974](https://github.com/dso-toolkit/dso-toolkit/issues/1974))
